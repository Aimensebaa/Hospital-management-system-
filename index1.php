...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp المستشفى العام</h4></a>
    ...
    <div class="row">
        <div class="col-md-7" style="padding-left: 180px; ">
            ...
            <div style="color: white;">
                <h4 style="font-family: 'IBM Plex Sans', sans-serif;">نحن هنا لخدمتك!</h4>
            </div>
        </div>
            ...
            <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="card-body">
                    <center>
                        ...
                        <br>
                        <h3 style="margin-top: 10%">تسجيل الدخول للمريض</h3><br>
                        <form class="form-group" method="POST" action="func.php">
                            <div class="row" style="margin-top: 10%">
                                <div class="col-md-4"><label>البريد الإلكتروني: </label></div>
                                <div class="col-md-8"><input type="text" name="email" class="form-control" placeholder="أدخل البريد الإلكتروني" required/></div><br><br>
